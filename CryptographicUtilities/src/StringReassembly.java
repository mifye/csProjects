...
public final class StringReassembly {
    ...
    public static int overlap(String str1, String str2) {
        ...
        //christmasDay = str1 //12
        //hidemasDay = str2 //10
        int maxOverlap = str2.length() - 1; //9
    ...
    public static String combination(String str1, String str2, int overlap) {
        ...
        //create new combined string using substring method
        String newStr1 = str1.substring(0, str1.length() - overlap);
        return newStr1 + str2;
    }
    ...
    public static void addToSetAvoidingSubstrings(Set<String> strSet,
        ...
        //add to check for non-null empty string
        if (!str.isEmpty()) {

            //initialize boolean as false
            boolean strIsSubstring = false;

            //loop through set and check if str is a substring of an element
            ...
            /*
             * if str is added, iterate again and remove all elements that are
             * substrings of str
             */

            if (!strIsSubstring) {

                //add str to strSet and make new set to add correct elements to
                strSet.add(str);
                Set<String> temp = strSet.newInstance();

                //loop through setStr and add non-substrings of str to temp
                for (String element : strSet) {
                ...
                //clear #strSet and add temp to make updated strSet
                strSet.clear();
                strSet.add(temp);
            }
        }
    ...
    public static Set<String> linesFromInput(SimpleReader input) {
        ...
        Set<String> updatedInput = new Set2<String>();
        while (!input.atEOS()) {
            addToSetAvoidingSubstrings(updatedInput, input.nextLine());
        }
